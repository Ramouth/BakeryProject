    ...
    <div className="container">
      <div className="card">
        ...
        <p className="intro-text" style={{ marginBottom: '35px' }}>
          This site is a small project from DTU 🎓, designed to help you discover the best bakeries in Copenhagen. Whether you're searching for the crispiest croissant 🥐 or the perfect sourdough 🍞, our platform makes it easy to find the right bakery for you!
        </p>
        <p>
